...
import os
import sys
# Point to the project's root directory so autodoc can find the library
sys.path.insert(0, os.path.abspath('../..'))


# -- Project information -----------------------------------------------------

project = 'AutoCAD Python Library'
copyright = '2025, Jones-peter'
author = 'Jones-peter'
...
extensions = [
    ...
    'myst_parser',             # Allow Markdown files to be used
]
